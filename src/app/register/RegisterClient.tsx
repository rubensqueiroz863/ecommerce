    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 px-4">
      ...
      >
        ...
        <div className="flex flex-col gap-1">
          ...
          <div className="relative flex items-center">
            ...
            <button
              ...
              className="absolute cursor-pointer text-(--bg-secondary) right-3 p-1 hover:scale-110 transition"
            >
              {isShowingPassword ? (
                <svg
        ...
        <button
          type="submit"
          disabled={loading}
          className="bg-black cursor-pointer hover:-translate-y-1 text-white p-3 rounded-lg font-medium hover:opacity-90 hover:shadow-md transition-all duration-200 disabled:opacity-50"
        >
